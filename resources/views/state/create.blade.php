    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h2 class="card-title mb-0">Add State</h2>
                    </div>    
                </div>
                <hr class="mt-0" />


                <form id="stateform" name="stateform" action="{{ route('state.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form-body">
                        <div class="row p-t-10">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control" name="country" id="country">
                                    ...
                                    @if(count($country_list) > 0)
                                        @foreach($country_list as $country)
                                        <option value="{{ $country->id }}" @if(old('name')) @if(old('country') == $country->id) selected @endif @endif>{{ $country->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') ?? '' }}" placeholder="State Name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="{{ old('code') ?? '' }}" placeholder="State Code" disabled="true" onkeypress="return isOnlyNumber();" />
                                </div>
                            </div>
