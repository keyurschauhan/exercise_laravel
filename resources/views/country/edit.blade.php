    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h2 class="card-title mb-0">Edit Country</h2>
                    </div>    
                </div>
                <hr class="mt-0" />


                <form id="countryform" name="countryform" action="{{ route('country.update',$country_details->id) }}" method="POST">
                @method('put')
                @csrf
                    ...
                    <div class="form-body">
                        <div class="row p-t-10">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ $country_details->name }}">
                                </div>
                            </div>
