    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h2 class="card-title mb-0">Add City</h2>
                    </div>    
                </div>
                <hr class="mt-0" />


                <form id="cityform" name="cityform" action="{{ route('city.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form-body">
                        <div class="row p-t-10">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') ?? '' }}" placeholder="City Name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="state" id="state">
                                    ...
                                    @if(count($state_list) > 0)
                                        ...
                                        <option value="{{ $state->id }}" @if(old('state')) @if(old('state') == $state->id) selected @endif @endif>{{ $state->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="{{ old('code') ?? '' }}" placeholder="State Code" disabled="true" />
                                </div>
                            </div>
